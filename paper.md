...
Github Repo: https://github.com/jane2800/uci-redesign
...
<figure class="image-grid">
  ...
  <figure>
    <img src="images/uci-evidence/IMG_6285.PNG" alt="Flowchart before Redesign" width=25%>
...
## 5. The Core Task the Interface Should Support
...
## 6. Analysis of Why the Interface Fails
...
<figure>
  <img src="images/Flowchart.png" alt="Flowchart before Redesign" height=50%>
  <figcaption>Figure 15: Flowchart of system before redesign.</figcaption>
</figure>

---

## 7. Redesign Concept Overview
...
<figure>
  <img src="images/Flowchart-2.png" alt="Redesign Flowchart" height=50%>
  <figcaption>Figure 16: Flowchart of Redesign.</figcaption>
</figure>

---

## 8. First Screen Sketch
<figure>
  <img src="images/FirstScreen.png" alt="Redesign Flowchart" height=50%>
  <figcaption>Figure 17: Home Screen Sketch.</figcaption>
</figure>

---

## 9. Minimum Screens for Final Prototype
In total the Final Prototype will require 7 screens, this is a quick overview of them:
<ol style="margin-left: 0.5em;">
    <li>1. Home Screen: Overview of what the cinema has to offer. </li>
    <li>2. Movie Overview: A dedicate screen for information on the selected movie, and timing options </li>
    <li>3. Ticket Selection: A dedicated screen to only selecting the number of tickets the user wants</li>
    <li>4. Seat Selection: A dedicated screen to selecting seat, with legend support to indicate prices</li>
    <li>5. Login: Login verfication to make the booking</li>
    <li>6. Guest Login: To demostrate how the user can continue as a guest</li>
    <li>7. Order Overview: Overview of the tickets, cost, time and all esentiall information</li>
</ol>

---

## 10. Expected Design Challanges
<ol>
